    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-purple-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="w-full h-12 text-lg rounded-xl border-2 border-cyan-200 focus:border-cyan-400 focus:ring-cyan-200 transition-all duration-300 focus:scale-105"
                />
              </div>
              ...
              <div className="space-y-2 lg:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 text-lg rounded-xl border-2 border-indigo-200 focus:border-indigo-400 focus:ring-indigo-200 focus:outline-none resize-none transition-all duration-300 focus:scale-105"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full h-12 text-lg rounded-xl border-2 border-green-200 focus:border-green-400 focus:ring-green-200 px-4 focus:outline-none transition-all duration-300 focus:scale-105"
                >
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full h-12 text-lg rounded-xl border-2 border-emerald-200 focus:border-emerald-400 focus:ring-emerald-200 px-4 focus:outline-none transition-all duration-300 focus:scale-105"
                >
