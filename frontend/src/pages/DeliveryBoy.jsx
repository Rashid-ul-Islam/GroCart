      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">DeliveryPro Dashboard</h1>
          ...
          <div className="flex items-center justify-between mt-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">All-in-One Dashboard</h2>
              <p className="text-gray-600">Monitor deliveries, performance, schedule and more</p>
            </div>
            ...
            <TabsList className="grid w-full grid-cols-5 bg-white shadow-sm rounded-lg p-1">
              {[
                ...
                <TabsTrigger
                  key={value}
                  value={value}
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-md transition-all duration-200 data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 data-[state=active]:shadow-sm"
                >
                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <Badge variant="outline">8:00 AM - 2:00 PM</Badge>
                    </div>
                    <p className="text-sm text-gray-600">12 deliveries scheduled</p>
                  </div>
                  <div className="border rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-medium">Evening Shift</span>
                      <Badge variant="outline">2:00 PM - 8:00 PM</Badge>
                    </div>
                    <p className="text-sm text-gray-600">8 deliveries scheduled</p>
                  </div>
                </div>
              </div>
              <PerformanceChart deliveryBoyId={deliveryBoyId || "1"} />
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    <Input placeholder="Order ID" className="flex-1" />
                    <Input placeholder="Customer Name" className="flex-1" />
                    <Button>Search</Button>
                  </div>
                  <div className="border rounded-lg p-4">
                    <p className="text-center text-gray-500">Enter search criteria to find orders</p>
                  </div>
                </div>
              </div>
              <AssignedDeliveries />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input value="John Driver" readOnly />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input value="john.driver@example.com" readOnly />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Vehicle Type</label>
                      <Input value="Motorcycle" readOnly />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">License Plate</label>
                      <Input value="ABC-1234" readOnly />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Rating</label>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">4.8 ⭐</Badge>
                        <span className="text-sm text-gray-600">Based on 247 deliveries</span>
                      </div>
                    </div>
                  </div>
                </div>
