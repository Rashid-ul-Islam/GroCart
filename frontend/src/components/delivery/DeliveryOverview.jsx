    ...
    return (
      <div className="min-h-screen bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 flex items-center">
          ...
          <span className="ml-3 text-gray-800 font-semibold">Loading delivery overview...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-blue-500">
            ...
            <p className="text-sm font-medium text-gray-600 mb-2">Active Deliveries</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-yellow-500">
            ...
            <p className="text-sm font-medium text-gray-600 mb-3">On-Time Rate</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-purple-500">
            ...
            <p className="text-sm font-medium text-gray-600">Available Delivery Boys</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <p className="text-gray-600 mb-6">Latest orders requiring attention</p>
            ...
            <Button className="w-full mt-6 bg-gradient-to-r from-slate-600 to-slate-400 hover:from-slate-800 hover:to-slate-600 text-white py-3 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
              View All Orders
            </Button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <p className="text-gray-600 mb-6">Common delivery management tasks</p>
            
            <div className="space-y-4">
              <Button className="w-full bg-gradient-to-r from-green-800 to-green-400 hover:from-green-900 hover:to-green-600 text-white py-4 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-start">
                <Package className="mr-3 h-5 w-5" />
                Assign Pending Orders
              </Button>

              <Button className="w-full bg-gradient-to-r from-blue-800 to-blue-400 hover:from-blue-1200 hover:to-blue-700 text-white py-4 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-start">
                <Users className="mr-3 h-5 w-5" />
                Manage Delivery Boys
              </Button>

              <Button className="w-full bg-gradient-to-r from-yellow-700 to-yellow-300 hover:from-yellow-900 hover:to-yellow-500 text-white py-4 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-start">
                <Clock className="mr-3 h-5 w-5" />
                View Delayed Deliveries
              </Button>

              <Button className="w-full bg-gradient-to-r from-red-700 to-red-400 hover:from-red-900 hover:to-red-600 text-white py-4 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-start">
                <AlertTriangle className="mr-3 h-5 w-5" />
                Handle Issues
              </Button>

              <Button className="w-full bg-gradient-to-r from-purple-800 to-purple-400 hover:from-purple-950 hover:to-purple-600 text-white py-4 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-start">
