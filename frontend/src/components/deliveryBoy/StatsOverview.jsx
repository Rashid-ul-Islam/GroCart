        ...
        setStats([
          {
            ...
            change:
              apiStats.totalDeliveries > 0
                ? `${apiStats.totalDeliveries} completed`
                : "No deliveries yet",
            icon: FileText,
            color: "text-blue-600",
            bgColor: "bg-blue-100",
          },
          {
            ...
            change:
              apiStats.onTimeRate >= 90
                ? "Excellent!"
                : apiStats.onTimeRate >= 80
                ? "Good"
                : "Needs improvement",
            icon: Clock,
            color:
          ...
          },
          {
            ...
            change:
              apiStats.completedToday > 0
                ? `${apiStats.completedToday} today`
                : "No deliveries today",
            icon: CheckCircle,
            color: "text-purple-600",
            bgColor: "bg-purple-100",
          },
          {
            ...
            change:
              apiStats.totalRatings > 0
                ? `${apiStats.totalRatings} reviews`
                : "No reviews yet",
            icon: User,
            color:
              apiStats.customerRating >= 4.5
                ? "text-orange-600"
                : apiStats.customerRating >= 4.0
                ? "text-yellow-600"
                : "text-red-600",
            bgColor:
              apiStats.customerRating >= 4.5
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-blue-500 hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-700 bg-gray-100 px-3 py-1 rounded-full inline-block font-medium">
                    {stat.change}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
              ...
              <p className="text-sm text-blue-600">
                Plan routes efficiently and start deliveries early
              </p>
            </div>
            ...
            <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
              ...
              <p className="text-sm text-purple-600">
                Set and achieve daily delivery targets
              </p>
            </div>
          </div>
        </div>
